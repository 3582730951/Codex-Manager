...
const HTTP_WORKER_FACTOR: usize = 2;
const HTTP_WORKER_MIN: usize = 4;
const HTTP_STREAM_WORKER_FACTOR: usize = 1;
const HTTP_STREAM_WORKER_MIN: usize = 2;
const HTTP_QUEUE_FACTOR: usize = 2;
const HTTP_QUEUE_MIN: usize = 16;
const HTTP_STREAM_QUEUE_FACTOR: usize = 1;
const HTTP_STREAM_QUEUE_MIN: usize = 8;
