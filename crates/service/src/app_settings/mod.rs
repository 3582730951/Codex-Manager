...
pub use gateway::{
    ...
    current_gateway_context_replay_enabled, current_gateway_free_account_max_model,
    current_gateway_originator, current_gateway_replay_max_turns,
    ...
    set_gateway_upstream_stream_timeout_ms, set_gateway_user_agent_version, AffinitySettingsInput,
