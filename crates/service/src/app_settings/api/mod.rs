...
pub(super) use super::gateway::{
    current_background_tasks_snapshot_value, current_gateway_affinity_routing_mode,
    ...
    residency_requirement_options, set_gateway_affinity_routing_mode,
...
pub(super) use super::{
    APP_SETTING_CLOSE_TO_TRAY_ON_CLOSE_KEY, APP_SETTING_GATEWAY_AFFINITY_ROUTING_MODE_KEY,
