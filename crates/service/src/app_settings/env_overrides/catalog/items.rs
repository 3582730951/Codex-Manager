...
pub(crate) const APP_SETTINGS_ENV_RESERVED_KEYS: &[&str] = &[
    ...
    "CODEXMANAGER_AFFINITY_ROUTING_MODE",
    "CODEXMANAGER_CLIENT_ENTITY_MODE",
    "CODEXMANAGER_CONTEXT_REPLAY_ENABLED",
    "CODEXMANAGER_AFFINITY_SOFT_QUOTA_PERCENT",
    "CODEXMANAGER_REPLAY_MAX_TURNS",
    "CODEXMANAGER_EDGE_ENTITY_TRUSTED_CIDRS",
    "CODEXMANAGER_PEER_RUNTIME_TRUSTED_CIDRS",
    "CODEXMANAGER_PEER_RUNTIME_TTL_SECS",
...
pub(crate) const ENV_OVERRIDE_CATALOG: &[EnvOverrideCatalogItem] = &[
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_REQUEST_COMPRESSION_MIN_BYTES",
        "请求压缩最小阈值（字节）",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "16384",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_REQUEST_SPILL_THRESHOLD_BYTES",
        "请求体落盘阈值（字节）",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "1048576",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_STREAM_PUMP_CHANNEL_CAPACITY",
        "SSE 帧泵通道容量",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "8",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_STREAM_PUMP_THREAD_STACK_KB",
        "SSE 帧泵线程栈（KB）",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "256",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_EXPERIMENTAL_PREPARED_REQUEST",
        "启用实验性请求准备态",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "0",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_EXPERIMENTAL_ASYNC_REQUEST_LOG",
        "启用实验性异步请求日志",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "0",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_EXPERIMENTAL_SSE_FRAME_PUMP_V2",
        "启用实验性 SSE 帧泵 V2",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "0",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_EXPERIMENTAL_CAPPED_HTTP_WORKERS",
        "启用实验性 HTTP Worker 上限",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "0",
    ),
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_HTTP_STREAM_QUEUE_MAX",
        "流式请求最大队列",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RESTART,
        "32",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_HTTP_STREAM_WORKER_MAX",
        "流式请求最大 Worker",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RESTART,
        "4",
